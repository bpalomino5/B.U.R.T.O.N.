...
def main(api_endpoint, credentials,
    ...
    with SampleTextAssistant(lang, 'burton-88a21-burton-ccmqns', 'burton-88a21', display,
...
class Assistant(object):
  def __init__(self):
    ...
    self.assistant = SampleTextAssistant('en-US', 'burton-88a21-burton-ccmqns', 'burton-88a21', False,
                             grpc_channel, DEFAULT_GRPC_DEADLINE)

  def query(self,text):
    response_text, response_html = self.assistant.assist(text_query=text)
